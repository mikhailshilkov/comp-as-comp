...
func NewStaticPage(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("go-components:index:StaticPage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o StaticPageOutput) Endpoint() pulumi.StringOutput {
	return o.ApplyT(func(v *StaticPage) pulumi.StringOutput { return v.Endpoint }).(pulumi.StringOutput)
}
