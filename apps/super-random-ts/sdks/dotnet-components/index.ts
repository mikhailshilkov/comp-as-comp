...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "dotnet-components:index:RandomComponent":
...
pulumi.runtime.registerResourceModule("dotnet-components", "index", _module)
pulumi.runtime.registerResourcePackage("dotnet-components", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:dotnet-components") {
