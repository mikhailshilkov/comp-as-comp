...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "python-components:index:RandomComponent":
                return new RandomComponent(name, <any>undefined, { urn })
            case "python-components:index:StaticPage":
...
pulumi.runtime.registerResourceModule("python-components", "index", _module)
pulumi.runtime.registerResourcePackage("python-components", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:python-components") {
